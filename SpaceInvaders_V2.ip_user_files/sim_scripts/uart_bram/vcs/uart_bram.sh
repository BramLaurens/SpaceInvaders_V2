...
#
# Script generated by Vivado on Tue Jan 13 19:57:56 CET 2026
# SW Build 6140274 on Wed May 21 22:58:25 MDT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : uart_bram.sh
...
#
# Usage        : uart_bram.sh
#                uart_bram.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                uart_bram.sh [-reset_run]
#                uart_bram.sh [-reset_log]
#                uart_bram.sh [-help]
#
...
#                script (type 'uart_bram.sh -help' for more information).
#
...
# script info
echo -e "uart_bram.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./uart_bram.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.uart_bram xil_defaultlib.glbl -o uart_bram_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./uart_bram_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/bram-laurens/SpaceInvaders_V2/SpaceInvaders_V2.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key uart_bram_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc uart_bram_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./uart_bram.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: uart_bram.sh [-help]\n\
Usage: uart_bram.sh [-step]\n\
Usage: uart_bram.sh [-lib_map_path]\n\
Usage: uart_bram.sh [-reset_run]\n\
Usage: uart_bram.sh [-reset_log]\n\
Usage: uart_bram.sh [-keep_index]\n\
Usage: uart_bram.sh [-noclean_files]\n\n\
